...
class SaleLine(models.Model):
    ...
    discountAmount = models.DecimalField(max_digits=10, decimal_places=2, null=True)
    discountPercent = models.DecimalField(max_digits=10, decimal_places=2, null=True)
